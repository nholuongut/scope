...
import (
	...
	s_reflect "github.com/nholuongut/scope/test/reflect"
)
...
func makeTestReport() report.Report {
	...
	r.Overlay.WithMetadataTemplates(report.MetadataTemplates{
		"nholuongut_encryption": report.MetadataTemplate{ID: "nholuongut_encryption", Label: "Encryption", Priority: 4, From: "latest"},
	}).
