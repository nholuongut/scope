...
class CloudFeature extends React.Component {
  ...
  render() {
    if (process.env.nholuongut_CLOUD) {
    ...
    // also show if not in nholuongut cloud?
...
// TODO: Remove this component as part of https://github.com/nholuongut/scope/issues/3278.
