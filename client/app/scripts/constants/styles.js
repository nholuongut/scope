...
export const NODE_DETAILS_TABLE_COLUMN_WIDTHS = {
  ...
  // nholuongut connections
  nholuongut_connection_connection: NODE_DETAILS_TABLE_CW.XXL,
  nholuongut_connection_info: NODE_DETAILS_TABLE_CW.XL,
  nholuongut_connection_state: NODE_DETAILS_TABLE_CW.L,
};
