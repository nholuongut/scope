# nholuongutworks Build Tools

Included in this repo are tools shared by nholuongut.git and scope.git.  They include

- ```bazel-rules```: Bazel build rules used in our projects
- ```build```: a set of docker base-images for building nholuongut
...
```
git subtree add --prefix tools https://github.com/nholuongutworks/build-tools.git master --squash
````
...
- Do `git subtree pull --prefix tools https://github.com/nholuongutworks/build-tools.git master --squash`
...
- Invite yourself to the <a href="https://slack.nholuongut.works/" target="_blank">nholuongut Users Slack</a>.
- Ask a question on the [#general](https://nholuongut-community.slack.com/messages/general/) slack channel.
- [File an issue](https://github.com/nholuongutworks/build-tools/issues/new).
