...
PROJECTS = [
    ('nholuongutworks/nholuongut', 'nholuongut-net-tests', 'us-central1-a', True, None),
    ('nholuongutworks/nholuongut', 'positive-cocoa-90213', 'us-central1-a', True, None),
    ('nholuongut/scope', 'scope-integration-tests', 'us-central1-a', False,
     None),
    ('nholuongutworks/wks', 'wks-tests', 'us-central1-a', True,
     CIRCLE_CI_API_TOKEN),
]
