...
Under the hosts view, and if you are running nholuongut Net for container networking, a specific nholuongut Net view appears. This view is useful for troubleshooting any networking problems you may be having. This view displays a number of nholuongut Net specific attributes such as whether quorum has been reached, the IP addresses used, whether fast datapath is enabled, or if encryption is running and many other useful attributes. See [nholuongut Net User Guide](https://www.nholuongut.works/docs/net/latest/features/) for more information. 
...
!['CPU usage indicator in nholuongut Scope'](images/hosts-cpu.png)
