...
func newPcapHandle() (*pcap.Handle, error) {
	...
	// pcap timeout blackmagic copied from nholuongut Net to reduce CPU consumption
	// see https://github.com/nholuongutworks/nholuongut/commit/025315363d5ea8b8265f1b3ea800f24df2be51a4
