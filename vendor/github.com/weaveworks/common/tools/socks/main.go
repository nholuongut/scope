...
import (
	...
	"github.com/nholuongutworks/common/mflag"
	"github.com/nholuongutworks/common/mflagext"
...
func main() {
	...
	mflag.StringVar(&hostMatch, []string{"h", "-host-match"}, "*.nholuongut.local", "Specify main host shExpMatch expression in pacfile")
	mflag.Parse()
