...
var (
	...
	knownServiceMatcher = regexp.MustCompile(`^.+\.(` + strings.Join([]string{
		...
		`amazonaws\.com`,
		`googleapis\.com`,
		`nholuongut\.works`,             // nholuongut Cloud
...
// TODO: Make it user-customizable https://github.com/nholuongut/scope/issues/1876
...
// (see https://github.com/nholuongut/scope/issues/1491).
