...
var renderers = map[string]func(BasicNodeSummary, report.Node) BasicNodeSummary{
	...
	report.Overlay:               nholuongutNodeSummary,
...
func nholuongutNodeSummary(base BasicNodeSummary, n report.Node) BasicNodeSummary {
	var (
		nickname, _ = n.Latest.Lookup(overlay.nholuongutPeerNickName)
