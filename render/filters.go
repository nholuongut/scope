...
func IsApplication(n report.Node) bool {
	...
	roleLabel, _ := n.Latest.Lookup(docker.LabelPrefix + "works.nholuongut.role")
	if roleLabel == "system" {
		return false
	}
	roleLabel, _ = n.Latest.Lookup(docker.ImageLabelPrefix + "works.nholuongut.role")
	if roleLabel == "system" {
		return false
	}
...
var systemImagePrefixes = map[string]struct{}{
	"swarm":                          {},
	"nholuongut/scope":               {},
	"nholuongutworks/nholuongutdns":            {},
	"nholuongutworks/nholuongut":               {},
	"nholuongutworks/nholuongutproxy":          {},
	"nholuongutworks/nholuongutexec":           {},
