...
if __name__ == "__main__":
    ...
    parser.add_argument('-redis', default="redis.nholuongut.local")
    parser.add_argument('-search', default="http://search.nholuongut.local:80/")
    parser.add_argument('-qotd', default="qotd.nholuongut.local")
    parser.add_argument('-echo', default="http://echo.nholuongut.local:80/")
